...
def pistasvtexto():
    ...
    if pistaseleccionada != pistaocupada:
        print("Díríjase hacia la pista", pistaseleccionada)
        pistasStexto1()
    else:
...
#Pasajeros Norte Complejidad 2
def norte_pasajeros_2():
...
def pistasKD():
    ...
    pistaseleccionada = random.choice(pista_lista)
    if pistaseleccionada != pistaocupada:
        print("Cruce la pista 09R y continue por la pista", pistaseleccionada, "hasta llegar a D")
...
def pistasY():
    ...
    pistaseleccionada = random.choice(pista_lista)
    if pistaseleccionada != pistaocupada:
        print("Cruce la pista 09R y continúe por la pista", pistaseleccionada, "y aguarde indicaciones")
    else:
        while pistaseleccionada == pistaocupada:
            pistaseleccionada = random.choice(pista_lista)
            if pistaseleccionada !=  pistaocupada:
